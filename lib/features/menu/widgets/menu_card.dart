...
class _MenuCardState extends State<MenuCard> {
  ...
  void _showSizeSelectionDialog(BuildContext context) {
    showDialog(
      ...
      builder: (BuildContext dialogContext) =>
          SizeSelectionDialog(item: widget.item),
    );
  }
  ...
  void _showSpiceSelectionDialog(BuildContext context) {
    showDialog(
      context: context,
      builder: (BuildContext dialogContext) =>
          SpiceSelectionDialog(item: widget.item),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    bool requiresCustomization =
        widget.item.sizes.isNotEmpty || widget.item.spiceLevels.isNotEmpty;
              ...
              child: Card(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    MenuCardImageHeader(item: widget.item),
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                if (widget.item.foodLabel != null &&
                                    widget.item.foodLabel!['url'] != null) ...[
                                  const SizedBox(width: 8),
                                  Tooltip(
                                    message:
                                        widget.item.foodLabel!['type']
                                            ?.toString() ??
                                        "",
                                    // Forces the tooltip to appear instantly on a normal mobile tap!
                                    triggerMode: TooltipTriggerMode.tap,
                                    // Makes the tooltip disappear after 2 seconds on mobile
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        // 🌟 FIX 2: Replaced deprecated withOpacity with withAlpha (15% of 255 = 38)
                                        boxShadow: [
                                          BoxShadow(
                            ...
                            ListenableBuilder(
                              ...
                              builder: (context, _) {
                                final cartItems = CartManager.instance.items
                                    .where(
                                      (i) =>
                                          i.item.menuId == widget.item.menuId,
                                    )
                                    .toList();
                                final quantityInCart = cartItems.fold(
                                  0,
                                  ...
                                  return SizedBox(
                                    ...
                                    child: ItemQuantityStepper(
                                      ...
                                      onIncrement: () => CartManager.instance
                                          .addItem(widget.item, quantity: 1),
                                      onDecrement: () =>
